...
class PrintReceiptCar(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not receipt_car_id:
            ...
            p.drawString(510, 970, 'Passport Issue Date: ')
            p.drawString(510, 920, 'Passport Issue Place: ')
            p.drawString(510, 870, 'Date of Birth: ')
            p.drawString(510, 820, 'Tel No: ')
            p.drawString(510, 770, 'License Type: ')
            
            p.drawString(510, 720, 'Emirates Id: ')
            p.drawString(50, 670, 'Leaving Date: ')
            p.drawString(260, 670, 'Time: ')
            p.drawString(510, 670, 'License Issue Place:')
            p.drawString(50, 620, 'Returning Date:')
            p.drawString(260, 620, 'Time: ' )
            p.drawString(510, 620, 'Tel No.( Working ):')
            p.drawString(510, 580, 'Address ( Working ): ')
            ...
            p.drawString(660, 970, receive_car.rent_agreement.driver.date_of_passport_issue.strftime('%d/%m/%Y') if receive_car.rent_agreement.driver and receive_car.rent_agreement.driver.date_of_passport_issue else '')
            p.drawString(660, 920, receive_car.rent_agreement.driver.place_of_issue)
            p.drawString(610, 870, receive_car.rent_agreement.driver.driver_dob.strftime('%d/%m/%Y') if receive_car.rent_agreement.driver and receive_car.rent_agreement.driver.driver_dob else '')
            p.drawString(610, 820, receive_car.rent_agreement.driver.driver_phone)
            p.drawString(610, 770, receive_car.rent_agreement.driver.license_type)
            p.drawString(610, 720, receive_car.rent_agreement.driver.emirates_id)
            p.drawString(650, 670, receive_car.rent_agreement.driver.driver_license_issue_place)
            ...
            p.drawString(660, 620, receive_car.rent_agreement.driver.driver_working_ph)
            ...
            print receive_car.rent_agreement.accident_passable, receive_car.rent_agreement.vehicle_scratch
