...
class PrintReceiptCar(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not receipt_car_id:
            ...
            p.drawString(300, y - 300, receive_car.rent_agreement.starting_date_time.strftime('%H:%M%p'))
            p.drawString(160, y - 350, receive_car.rent_agreement.end_date_time.strftime('%d/%m/%Y'))
            p.drawString(300, y - 350, receive_car.rent_agreement.end_date_time.strftime('%H:%M%p'))
            ...
            p.drawString(300, y - 400, receive_car.receipt_datetime.strftime('%H:%M%p') if receive_car.receipt_datetime else '')
