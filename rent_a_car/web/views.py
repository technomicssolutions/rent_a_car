...
class PrintRentAgreement(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not rent_agreement_id:
            ...
            p.drawString(510, 970, 'Passport Issued Date: ')
            p.drawString(760, 970, 'Issued Place: ')
            p.drawString(510, 920, 'Date of Birth: ')
            p.drawString(760, 920, 'Tel No: ')
            p.drawString(510, 770, 'Date & Place of License Issue: ')
            p.drawString(560, 730, 'Emirates Id: ')
            p.drawString(560, 680, 'License Type: ')
            p.drawString(510, 880, 'Address:')
            ...
            p.drawString(610, 530, 'Driver Tel. No ( Working )')
            ...
            p.drawString(660, 970, rent_agreement.driver.date_of_passport_issue.strftime('%d/%m/%Y') if rent_agreement.driver and rent_agreement.driver.date_of_passport_issue else '')
            p.drawString(860, 970, rent_agreement.driver.place_of_issue if rent_agreement.driver else '')
            ...
            p.drawString(810, 920, rent_agreement.driver.driver_phone if rent_agreement.driver else '')
            p.drawString(720, 770, (rent_agreement.driver.driver_license_issue_date.strftime('%d/%m/%Y') if rent_agreement.driver and rent_agreement.driver.driver_license_issue_date else '') + ' , ')
            p.drawString(800, 770, rent_agreement.driver.driver_license_issue_place if rent_agreement.driver else '' )
            p.drawString(650, 730, rent_agreement.driver.emirates_id if rent_agreement.driver else '')
            p.drawString(660, 680, rent_agreement.driver.license_type if rent_agreement.driver else '')
            p.drawString(580, 880, rent_agreement.driver.driver_address.replace('\n', ' ') if rent_agreement.driver and rent_agreement.driver.driver_address else '')
            p.drawString(650, 830, rent_agreement.driver.driver_license_expiry_date.strftime('%d/%m/%Y') if rent_agreement.driver and rent_agreement.driver.driver_license_expiry_date else '')
