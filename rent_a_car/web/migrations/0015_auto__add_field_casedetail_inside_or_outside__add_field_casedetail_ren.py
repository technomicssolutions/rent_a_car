...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseDetail.inside_or_outside'
        db.add_column(u'web_casedetail', 'inside_or_outside',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CaseDetail.rent_agreement_reference_no'
        db.add_column(u'web_casedetail', 'rent_agreement_reference_no',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CaseDetail.inside_or_outside'
        db.delete_column(u'web_casedetail', 'inside_or_outside')

        # Deleting field 'CaseDetail.rent_agreement_reference_no'
        db.delete_column(u'web_casedetail', 'rent_agreement_reference_no')
    ...
    models = {
        u'web.casedetail': {
            ...
            'inside_or_outside': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
