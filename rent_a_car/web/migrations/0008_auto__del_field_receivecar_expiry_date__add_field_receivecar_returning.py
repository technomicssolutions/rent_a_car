...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiveCar.expiry_date'
        db.delete_column(u'web_receivecar', 'expiry_date')

        # Adding field 'ReceiveCar.returning_date_time'
        db.add_column(u'web_receivecar', 'returning_date_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ReceiveCar.expiry_date'
        db.add_column(u'web_receivecar', 'expiry_date',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ReceiveCar.returning_date_time'
        db.delete_column(u'web_receivecar', 'returning_date_time')
