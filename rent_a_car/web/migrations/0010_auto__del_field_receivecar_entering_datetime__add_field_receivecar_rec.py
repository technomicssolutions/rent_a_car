...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReceiveCar.receipt_datetime'
        db.add_column(u'web_receivecar', 'receipt_datetime',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ReceiveCar.receipt_datetime'
        db.delete_column(u'web_receivecar', 'receipt_datetime')
