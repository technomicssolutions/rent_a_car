...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiveCar.passable'
        db.delete_column(u'web_receivecar', 'passable')

        # Deleting field 'ReceiveCar.accident'
        db.delete_column(u'web_receivecar', 'accident')
        ...
        # Adding field 'ReceiveCar.total_amount'
        db.add_column(u'web_receivecar', 'total_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'ReceiveCar.paid'
        db.add_column(u'web_receivecar', 'paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ReceiveCar.passable'
        db.add_column(u'web_receivecar', 'passable',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'ReceiveCar.accident'
        db.add_column(u'web_receivecar', 'accident',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)
        ...
        # Deleting field 'ReceiveCar.total_amount'
        db.delete_column(u'web_receivecar', 'total_amount')

        # Deleting field 'ReceiveCar.paid'
        db.delete_column(u'web_receivecar', 'paid')
