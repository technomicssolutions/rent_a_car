...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RentAgreement.leaving_meterreading'
        db.add_column(u'web_rentagreement', 'leaving_meterreading',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RentAgreement.leaving_meterreading'
        db.delete_column(u'web_rentagreement', 'leaving_meterreading')
