...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RentAgreement.total_amount'
        db.add_column(u'web_rentagreement', 'total_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)


        # Changing field 'RentAgreement.commission'
        db.alter_column(u'web_rentagreement', 'commission', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=2))

        # Changing field 'RentAgreement.reduction'
        db.alter_column(u'web_rentagreement', 'reduction', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=2))

        # Changing field 'RentAgreement.paid'
        db.alter_column(u'web_rentagreement', 'paid', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=2))

        # Changing field 'RentAgreement.rent'
        db.alter_column(u'web_rentagreement', 'rent', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=2))
    def backwards(self, orm):
        # Deleting field 'RentAgreement.total_amount'
        db.delete_column(u'web_rentagreement', 'total_amount')


        # Changing field 'RentAgreement.commission'
        db.alter_column(u'web_rentagreement', 'commission', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=2))

        # Changing field 'RentAgreement.reduction'
        db.alter_column(u'web_rentagreement', 'reduction', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=2))

        # Changing field 'RentAgreement.paid'
        db.alter_column(u'web_rentagreement', 'paid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2))

        # Changing field 'RentAgreement.rent'
        db.alter_column(u'web_rentagreement', 'rent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2))
    models = {
        u'web.client': {
