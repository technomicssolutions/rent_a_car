...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReceiveCar.returning_petrol'
        db.alter_column(u'web_receivecar', 'returning_petrol', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    def backwards(self, orm):

        # Changing field 'ReceiveCar.returning_petrol'
        db.alter_column(u'web_receivecar', 'returning_petrol', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=2))
    models = {
        u'web.casedetail': {
