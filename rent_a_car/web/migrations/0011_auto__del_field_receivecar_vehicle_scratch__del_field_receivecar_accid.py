...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiveCar.vehicle_scratch'
        db.delete_column(u'web_receivecar', 'vehicle_scratch')

        # Deleting field 'ReceiveCar.accident_passable'
        db.delete_column(u'web_receivecar', 'accident_passable')

        # Adding field 'RentAgreement.vehicle_scratch'
        db.add_column(u'web_rentagreement', 'vehicle_scratch',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'RentAgreement.accident_passable'
        db.add_column(u'web_rentagreement', 'accident_passable',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ReceiveCar.vehicle_scratch'
        db.add_column(u'web_receivecar', 'vehicle_scratch',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'ReceiveCar.accident_passable'
        db.add_column(u'web_receivecar', 'accident_passable',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Deleting field 'RentAgreement.vehicle_scratch'
        db.delete_column(u'web_rentagreement', 'vehicle_scratch')

        # Deleting field 'RentAgreement.accident_passable'
        db.delete_column(u'web_rentagreement', 'accident_passable')
