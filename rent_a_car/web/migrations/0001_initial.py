...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_rentagreement', (
            ...
            ('with_driver', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('driver_passport_no', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
