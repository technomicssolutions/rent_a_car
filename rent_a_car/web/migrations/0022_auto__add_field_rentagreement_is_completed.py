...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RentAgreement.is_completed'
        db.add_column(u'web_rentagreement', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RentAgreement.is_completed'
        db.delete_column(u'web_rentagreement', 'is_completed')
