...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReceiveCar.expiry_date'
        db.alter_column(u'web_receivecar', 'expiry_date', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    def backwards(self, orm):

        # Changing field 'ReceiveCar.expiry_date'
        db.alter_column(u'web_receivecar', 'expiry_date', self.gf('django.db.models.fields.DateField')(null=True))
    models = {
        u'web.client': {
