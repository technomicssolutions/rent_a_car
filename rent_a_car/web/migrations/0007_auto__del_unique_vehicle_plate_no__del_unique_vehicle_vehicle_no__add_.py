...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Vehicle', fields ['plate_no', 'vehicle_no']
        db.create_unique(u'web_vehicle', ['plate_no', 'vehicle_no'])

    def backwards(self, orm):
        # Removing unique constraint on 'Vehicle', fields ['plate_no', 'vehicle_no']
        db.delete_unique(u'web_vehicle', ['plate_no', 'vehicle_no'])
