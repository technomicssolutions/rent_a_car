...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReceiveCar.reduction'
        db.add_column(u'web_receivecar', 'reduction',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ReceiveCar.reduction'
        db.delete_column(u'web_receivecar', 'reduction')
