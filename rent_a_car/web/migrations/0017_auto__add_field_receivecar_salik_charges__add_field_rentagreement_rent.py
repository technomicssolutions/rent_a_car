...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReceiveCar.salik_charges'
        db.add_column(u'web_receivecar', 'salik_charges',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'RentAgreement.rental_entitled_in_km'
        db.add_column(u'web_rentagreement', 'rental_entitled_in_km',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RentAgreement.liable_to_pay_in_km'
        db.add_column(u'web_rentagreement', 'liable_to_pay_in_km',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ReceiveCar.salik_charges'
        db.delete_column(u'web_receivecar', 'salik_charges')

        # Deleting field 'RentAgreement.rental_entitled_in_km'
        db.delete_column(u'web_rentagreement', 'rental_entitled_in_km')

        # Deleting field 'RentAgreement.liable_to_pay_in_km'
        db.delete_column(u'web_rentagreement', 'liable_to_pay_in_km')
