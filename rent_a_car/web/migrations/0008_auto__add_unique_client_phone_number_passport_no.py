...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Client', fields ['phone_number', 'passport_no']
        db.create_unique(u'web_client', ['phone_number', 'passport_no'])

    def backwards(self, orm):
        # Removing unique constraint on 'Client', fields ['phone_number', 'passport_no']
        db.delete_unique(u'web_client', ['phone_number', 'passport_no'])
