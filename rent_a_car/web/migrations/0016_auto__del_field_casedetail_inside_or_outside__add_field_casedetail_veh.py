...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CaseDetail.vehicle_status'
        db.add_column(u'web_casedetail', 'vehicle_status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CaseDetail.vehicle_status'
        db.delete_column(u'web_casedetail', 'vehicle_status')
