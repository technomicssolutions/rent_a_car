...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vehicle.vehicle_condition'
        db.add_column(u'web_vehicle', 'vehicle_condition',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Vehicle.vehicle_condition'
        db.delete_column(u'web_vehicle', 'vehicle_condition')
