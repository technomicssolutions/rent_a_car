...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.emirates_id'
        db.add_column(u'web_client', 'emirates_id',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RentAgreement.with_driver'
        db.delete_column(u'web_rentagreement', 'with_driver')

    def backwards(self, orm):
        # Deleting field 'Client.emirates_id'
        db.delete_column(u'web_client', 'emirates_id')

        # Adding field 'RentAgreement.with_driver'
        db.add_column(u'web_rentagreement', 'with_driver',
