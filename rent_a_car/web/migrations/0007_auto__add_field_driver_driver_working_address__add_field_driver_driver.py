...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Driver.driver_working_address'
        db.add_column(u'web_driver', 'driver_working_address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.driver_working_ph'
        db.add_column(u'web_driver', 'driver_working_ph',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RentAgreement.agreement_type'
        db.delete_column(u'web_rentagreement', 'agreement_type')

        # Deleting field 'RentAgreement.commission'
        db.delete_column(u'web_rentagreement', 'commission')

        # Deleting field 'RentAgreement.type_of_contract'
        db.delete_column(u'web_rentagreement', 'type_of_contract')

        # Deleting field 'RentAgreement.reduction'
        db.delete_column(u'web_rentagreement', 'reduction')

    def backwards(self, orm):
        # Deleting field 'Driver.driver_working_address'
        db.delete_column(u'web_driver', 'driver_working_address')

        # Deleting field 'Driver.driver_working_ph'
        db.delete_column(u'web_driver', 'driver_working_ph')

        # Adding field 'RentAgreement.agreement_type'
        db.add_column(u'web_rentagreement', 'agreement_type',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RentAgreement.commission'
        db.add_column(u'web_rentagreement', 'commission',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'RentAgreement.type_of_contract'
        db.add_column(u'web_rentagreement', 'type_of_contract',
