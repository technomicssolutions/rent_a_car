...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RentAgreement.end_date_time'
        db.add_column(u'web_rentagreement', 'end_date_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RentAgreement.end_date_time'
        db.delete_column(u'web_rentagreement', 'end_date_time')
