...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiveCar.date'
        db.delete_column(u'web_receivecar', 'date')

        # Adding field 'ReceiveCar.entering_datetime'
        db.add_column(u'web_receivecar', 'entering_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ReceiveCar.date'
        db.add_column(u'web_receivecar', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ReceiveCar.entering_datetime'
        db.delete_column(u'web_receivecar', 'entering_datetime')
    ...
    models = {
        ...
        u'web.receivecar': {
            ...
            'entering_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
