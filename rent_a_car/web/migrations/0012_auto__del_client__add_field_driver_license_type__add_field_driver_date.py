...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Driver.license_type'
        db.add_column(u'web_driver', 'license_type',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.date_of_passport_issue'
        db.add_column(u'web_driver', 'date_of_passport_issue',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.place_of_issue'
        db.add_column(u'web_driver', 'place_of_issue',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Driver.rent'
        db.add_column(u'web_driver', 'rent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Driver.paid'
        db.add_column(u'web_driver', 'paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Driver.balance'
        db.add_column(u'web_driver', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)


        # Changing field 'CaseDetail.client'
        db.alter_column(u'web_casedetail', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Driver'], null=True))
        # Deleting field 'RentAgreement.client'
        db.delete_column(u'web_rentagreement', 'client_id')

    def backwards(self, orm):
        # Adding model 'Client'
        db.create_table(u'web_client', (
            ('expiry_license_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15, null=True, blank=True)),
            ...
            ('passport_no', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, null=True, blank=True)),
        ...
        # Deleting field 'Driver.license_type'
        db.delete_column(u'web_driver', 'license_type')

        # Deleting field 'Driver.date_of_passport_issue'
        db.delete_column(u'web_driver', 'date_of_passport_issue')

        # Deleting field 'Driver.place_of_issue'
        db.delete_column(u'web_driver', 'place_of_issue')

        # Deleting field 'Driver.rent'
        db.delete_column(u'web_driver', 'rent')

        # Deleting field 'Driver.paid'
        db.delete_column(u'web_driver', 'paid')

        # Deleting field 'Driver.balance'
        db.delete_column(u'web_driver', 'balance')


        # Changing field 'CaseDetail.client'
        db.alter_column(u'web_casedetail', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Client'], null=True))
        # Adding field 'RentAgreement.client'
        db.add_column(u'web_rentagreement', 'client',
    ...
    models = {
        ...
        u'web.driver': {
            ...
            'driver_working_ph': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
