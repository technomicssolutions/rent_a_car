...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RentAgreement.rent'
        db.add_column(u'web_rentagreement', 'rent',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'RentAgreement.paid'
        db.add_column(u'web_rentagreement', 'paid',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RentAgreement.rent'
        db.delete_column(u'web_rentagreement', 'rent')

        # Deleting field 'RentAgreement.paid'
        db.delete_column(u'web_rentagreement', 'paid')
