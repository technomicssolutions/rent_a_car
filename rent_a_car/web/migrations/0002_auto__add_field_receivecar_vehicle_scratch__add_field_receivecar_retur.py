...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReceiveCar.returning_petrol'
        db.add_column(u'web_receivecar', 'returning_petrol',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)

        # Adding field 'RentAgreement.leaving_petrol'
        db.add_column(u'web_rentagreement', 'leaving_petrol',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ReceiveCar.returning_petrol'
        db.delete_column(u'web_receivecar', 'returning_petrol')

        # Deleting field 'RentAgreement.leaving_petrol'
        db.delete_column(u'web_rentagreement', 'leaving_petrol')
    ...
    models = {
        ...
        u'web.receivecar': {
            ...
            'returning_petrol': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '25', 'decimal_places': '2'}),
        ...
        u'web.rentagreement': {
            ...
            'leaving_petrol': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '25', 'decimal_places': '2'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'paid': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '25', 'decimal_places': '2'}),
            'reduction': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '25', 'decimal_places': '2'}),
